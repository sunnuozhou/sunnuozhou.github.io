...
有数列 $a_n,b_n$ 满足 $(2+i)^n=a_n+b_ni$，求 $\sum\limits_{n=0}^\infin \frac{a_nb_n}{7^n}$。
...
$$
\begin{array}{rl}
ans&=\frac{i}4\sum\limits_{n=0}^\infin \frac{((2-i)^n+(2+i)^n)\times((2+i)^n-(2-i)^n)}{7^n}\\
&=\frac{i}4\sum\limits_{n=0}^\infin \frac{(2-i)^{2n}-(2+i)^{2n}}{7^n}\\
&=\frac{i}4(\sum\limits_{n=0}^\infin \frac{((2-i)^2)^{n}}{7^n}-\sum\limits_{n=0}^\infin \frac{((2+i)^2)^{n}}{7^n})\\
&=\frac7{16}
\end{array}
$$
